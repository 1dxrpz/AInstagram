 ...
 */
final class Version20230410204320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT NOT NULL, prompt VARCHAR(2048) NOT NULL, description VARCHAR(2048) DEFAULT NULL, image_id VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
